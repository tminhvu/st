    ...
    if (dmode & DRAW_FG) {
		...
		if ((base.ucolor[0] >= 0) &&
			...
			// RGB
                ...
                c.color.red = lcolor.red;
                c.color.green = lcolor.green;
                c.color.blue = lcolor.blue;
        ...
        // if want undercurls comment the line below and uncomment the block that follows
        XftDrawRect(xw.draw, &c, winx, winy + dc.font.ascent + 3, width, 1);
		/*
		XGCValues ugcv = {
